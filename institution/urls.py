...
urlpatterns =[
    ...
    path('<electricity>/building/electricity',buildingviews.ManageInstitutionElectricityDetailView, name = 'institution_electricity_availiblity'),
    ...
    path('<furniture>/building/furniture',buildingviews.ManageInstitutionFurnitureDetailView, name = 'institution_furniture_detail'),
]